...
const History: React.FC = () => {
  ...
  const [isLoading, setIsLoading] = useState(true); // Default true to prevent flickering
  ...
  const fetchData = async () => {
    ...
    try {
        // Simulate a tiny delay for smoother transition if operations are too fast
  ...
  return (
    <div className="p-4 pt-6 pb-32 max-w-md mx-auto h-full flex flex-col animate-fade-in">
      ...
      {/* Summary Card */}
      <div className="mb-8 rounded-3xl p-6 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 shadow-xl shadow-blue-500/30 dark:shadow-blue-900/30 text-white relative overflow-hidden transition-all duration-300">
