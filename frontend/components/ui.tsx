    ...
    <div className={`flex flex-col gap-2 mb-4 ${className}`}>
      ...
      <div className="relative w-full overflow-hidden rounded-2xl">
        ...
        <input
          ...
          className={`w-full box-border max-w-full h-14 bg-white dark:bg-gray-900/80 border border-gray-200 dark:border-gray-700 rounded-2xl ${isDate ? 'text-base' : 'text-xl'} text-gray-900 dark:text-white px-4 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all placeholder-gray-400 dark:placeholder-gray-600 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none ${icon ? 'pl-12' : ''} ${isDate ? '[&::-webkit-date-and-time-value]:text-left' : ''}`}
          {...props}
        />
      </div>
    </div>
